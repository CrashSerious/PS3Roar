...
#endif
int xroar_fullscreen = 1; // default to full screen
...
void toggleDOS()
{
	running_config.dos_type = running_config.dos_type++;
	if (running_config.dos_type > DOS_DELTADOS) /* DOS_DELTADOS is the highest DOS define (3) */ 
		running_config.dos_type = 0;
	/* Reset everything */
...
#ifndef ROMPATH
# define ROMPATH "/dev_hdd0/game/PS3Roar00/USRDIR/BIOS/"
#endif
#ifndef CONFPATH
# define CONFPATH "/dev_hdd0/game/PS3Roar00/USRDIR/BIOS/"
#endif
...
int xroar_init(int argc, char **argv) {
	...
	xroar_rom_path = "/dev_hdd0/game/PS3Roar00/USRDIR/BIOS/";//getenv("XROAR_ROM_PATH");
	xroar_conf_path = "/dev_hdd0/game/PS3Roar00/USRDIR/BIOS/";//getenv("XROAR_CONF_PATH");
...
void xroar_shutdown(void) {
	...
	TTF_CloseFont( text_fontSmall);
	TTF_CloseFont( text_fontMedium);
	TTF_CloseFont( text_fontLarge);
	TTF_CloseFont( text_fontTiny);
